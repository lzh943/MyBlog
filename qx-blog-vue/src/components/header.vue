...
<!--						<el-menu-item index="/Reward"><i class="fa fa-wa fa-cny"></i> 赞赏</el-menu-item>-->
						<el-menu-item index="/Friendslink"><i class="fa fa-wa fa-link"></i>友链</el-menu-item>
            <el-menu-item index="/Reward"><i class="fa fa-pencil-square-o"></i>写博文</el-menu-item>
						<div class="userInfo">
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/bj.png)'}">
		<div class="scene">
			<div><span id="luke"></span></div>
		</div>
		<div class="h-information">

                    <img :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:'static/img/wu.png'" alt="">

			<h2 class="h-description">

                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"以为是初见，其实是重逢。"}}
